...
//     */
//    init(lengthInMinutes: Int = 0, attendees: [Card.Attendee] = []) {
...
//     */
//    func reset(lengthInMinutes: Int, attendees: [Card.Attendee]) {
//        self.lengthInMinutes = lengthInMinutes
//        self.speakers = attendees.speakers
//        secondsRemaining = lengthInSeconds
//        activeSpeaker = speakerText
...
//        ScrumTimer(lengthInMinutes: back, attendees: attendees)
//    }
//}
//
//extension Array where Element == Card.Attendee {
